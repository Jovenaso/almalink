...
@RestController 
@RequestMapping("iee-prestamo")
@Api(value = "iee-prestamo")
public class IeePrestamoController {
	@Autowired
	private IeePrestamoEmpleadoEquipoService service;
	...
	@ApiResponses({
			...
			@ApiResponse(code = HttpServletResponse.SC_FORBIDDEN, message = "El recurso no está disponible para éste usuario") })
	@PostMapping("/post")
	public ResponseEntity<?> post(@RequestBody IeePrestamoEmpleadoEquipoDto dto) {
		response = new HashMap<>();
	...
	@ApiResponses({
			...
			@ApiResponse(code = HttpServletResponse.SC_FORBIDDEN, message = "El recurso no está disponible para éste usuario") })
	@PutMapping("/put")
	public ResponseEntity<?> put(@RequestBody IeePrestamoEmpleadoEquipoDto dto) {
		response = new HashMap<>();
