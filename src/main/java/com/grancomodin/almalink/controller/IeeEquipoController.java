...
@RestController
@RequestMapping("iee-equipo")
@Api(value = "iee-equipo")
public class IeeEquipoController {
	@Autowired
	private IeeEquipoService service;
	...
	@ApiResponses({
			...
			@ApiResponse(code = HttpServletResponse.SC_FORBIDDEN, message = "El recurso no está disponible para éste usuario") })
	@PostMapping("/post")
	public ResponseEntity<?> post(@RequestBody IeeEquipoDto dto) {
		response = new HashMap<>();
	...
	@ApiResponses({
			...
			@ApiResponse(code = HttpServletResponse.SC_FORBIDDEN, message = "El recurso no está disponible para éste usuario") })
	@PutMapping("/put")
	public ResponseEntity<?> put(@RequestBody IeeEquipoDto dto) {
		response = new HashMap<>();
