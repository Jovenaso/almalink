...
@RestController 
@RequestMapping("iee-prestamo-devuelto")
@Api(value = "iee-prestamo-devuelto")
public class IeePrestamoDevueltoController {
	@Autowired
	private IeePrestamoEmpleadoEquipoDevueltoService service;
	...
	@ApiResponses({
			...
			@ApiResponse(code = HttpServletResponse.SC_FORBIDDEN, message = "El recurso no está disponible para éste usuario") })
	@PostMapping("/post")
	public ResponseEntity<?> post(@RequestBody IeePrestamoEmpleadoEquipoDevueltoDto dto) {
		response = new HashMap<>();
	...
	@ApiResponses({
			...
			@ApiResponse(code = HttpServletResponse.SC_FORBIDDEN, message = "El recurso no está disponible para éste usuario") })
	@PutMapping("/put")
	public ResponseEntity<?> put(@RequestBody IeePrestamoEmpleadoEquipoDevueltoDto dto) {
		response = new HashMap<>();
